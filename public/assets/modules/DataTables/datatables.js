 ...
 *   https://datatables.net/download/#bs5/dt-2.0.2/date-1.5.2/r-3.0.0/rg-1.5.0/sl-2.0.0
 *
 * Included libraries:
 *   DataTables 2.0.2, DateTime 1.5.2, Responsive 3.0.0, RowGroup 1.5.0, Select 2.0.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-2.0.2/date-1.5.2/r-3.0.0/rg-1.5.0/sl-2.0.0",
