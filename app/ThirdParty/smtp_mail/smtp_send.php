...
class SMTP_mail {
   ...
   // public $product_name;
    public function __construct() {
        ...
        $this->port = 465;
        $this->host = "mail.gov.in";       
        $this->username = "hphrc_shi@hp.bov.in";
        $this->password = "Hphrc@7801";
    }

    public function sendRegistrationDetails($email,$data) {
        $template=$data['template'];
        
        $this->sender_email ='noreply.registration@hphrc.hp.gov.in';
...
//        $this->mail->Body ='Welcome to RMSA \r\n\r\n Username: '.$data['userName'].'\r\n\r\n Password:'.$data['password'];
    ...
    public function sendCommentDetails($email,$data) {
        ...
        $this->sender_email ='noreply.caseupdate@hphrc.hp.gov.in';
    ...
    public function sendResetPasswordDetails($email,$data) {
        ...
        $this->sender_email ='noreply.password.reset@hphrc.hp.gov.in';

        $this->sender_name ='HPSHRC Support';

        $this->subject ='HPSHRC Support: Password Reset Notification';
...
//        $this->mail->Body ='Welcome to RMSA \r\n\r\n Username: '.$data['userName'].'\r\n\r\n Password:'.$data['password'];
    ...
    public function sendForgetLink($email,$data) {
        ...
        $this->sender_email ='noreply.forgot.password@hphrc.hp.gov.in';
...
//        $this->mail->Body ='Welcome to RMSA \r\n\r\n Username: '.$data['userName'].'\r\n\r\n Password:'.$data['password'];
    ...
    public function sendTestMail($email,$data) {
        ...
        $this->sender_email ='test@hphrc.hp.gov.in';
