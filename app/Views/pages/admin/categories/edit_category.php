            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <?= form_open(route_to('admin.edit_category',$category_code), ['class'=>'form-horizontal form-label-left','id' => 'edit_categories1','name'=>'editcategory']);
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-9 col-sm-12 col-xs-12">
                            <div class="row">
                                <div class="mb-3">
                                    <div class="col-md-3b col-sm-3 col-xs-12"></div>
                                        <div class="col-md-6 col-sm-6 col-xs-12">                                   
