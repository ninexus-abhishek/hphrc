...
<?= $this->section('content') ?>
    <div class="row">
        <div class="col-md-12 col-sm-z12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Category</h2>                    
                ...
                <div class="row justify-content-center">
                    ...
                    <br />
                    <?= form_open(route_to('admin.add_category'), ['class'=>'form-horizontal form-label-left','id' => 'add_categories1','name'=>'addcategories']) ?> 
                    <div class="row">
                       <div class="mb-3">
